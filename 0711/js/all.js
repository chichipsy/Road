...
$(function(){
    ...
    //------------Head Drag Carousel---------//
    // let down = false;
    // $("#head .content .carousel ul").mousedown(function () { 
    //     down = true;
    //     console.log(down);
    // });
    // $("#head .content .carousel ul").mouseup(function () { 
    //     down = false;
    //     console.log(down);
    // });
    // $("#head .content .carousel ul").mouseleave(function () { 
    //     down = false;
    //     console.log(down);
    // });
    // $("#head .content .carousel ul").mousemove(function (e) { 
